...
export default function PromptGenerator() {
  ...
  function generate() {
    ...
    setResult(`AI photo of ${safeSubject}, intentional composition, natural skin texture, detailed environment, professional lighting, 85mm lens, high detail, 4:5 aspect ratio`);
  }
